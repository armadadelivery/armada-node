...
**first_line** | **string** |  | [optional] [default to undefined]
...
**area** | **string** |  | [default to undefined]
**block** | **string** |  | [default to undefined]
**street** | **string** |  | [default to undefined]
**building** | **string** |  | [default to undefined]
**city** | **string** |  | [default to undefined]
**district** | **string** |  | [default to undefined]
**short_address** | **string** |  | [default to undefined]

## Example

```typescript
import { DeliveryRequestDestination } from '@armada/sdk-generated';

const instance: DeliveryRequestDestination = {
    contact_name,
    contact_phone,
    latitude,
    longitude,
